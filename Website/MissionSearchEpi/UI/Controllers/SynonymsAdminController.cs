...
namespace MissionSearchEpi.Controllers
{
    ...
    public class SynonymsAdminController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            try
            {
                ...
                if (!managedSynonyms.Any())
                    return View("~/MissionSearchEpi/UI/Views/SynonymsAdmin/notManaged.cshtml");

                view.Synonyms = mgr.GetSynonyms("english");

                return View("~/MissionSearchEpi/UI/Views/SynonymsAdmin/index.cshtml", view);
            }
            catch
            {
                return View("~/MissionSearchEpi/UI/Views/SynonymsAdmin/notManaged.cshtml", view);
            }
        }
        ...
        public ActionResult Add()
        {
            ...
            return View("~/MissionSearchEpi/UI/Views/SynonymsAdmin/add.cshtml", synonymMap);
        }
        ...
        public ActionResult Update()
        {
            ...
            return View("~/MissionSearchEpi/UI/Views/SynonymsAdmin/add.cshtml", synonymViewData);
        }
