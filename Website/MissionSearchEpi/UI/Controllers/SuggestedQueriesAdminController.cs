    ...
    public class SuggestedQueriesAdminController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            try
            {
                ...
                return View("~/MissionSearchEpi/UI/Views/SuggestedQueriesAdmin/index.cshtml", view);
            }
            catch
            {
                return View("~/MissionSearchEpi/UI/Views/SuggestedQueriesAdmin/notManaged.cshtml", view);
            }
        }
        ...
        public ActionResult Add()
        {
            ...
            return View("~/MissionSearchEpi/UI/Views/SuggestedQueriesAdmin/add.cshtml", view);
