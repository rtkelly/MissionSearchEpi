...
namespace BaseSite.Business.Util
{
    /// <summary>
    ...
    public class XmlParser
    {
        ...
        /// </summary>
        /// <param name="html">The XML for the smarform data</param>
        public XmlParser(string html)
        {
            xDoc = XDocument.Parse((!string.IsNullOrEmpty(html)) ? html : "<root></root>");
            Html = html;
        }
        ...
        public XhtmlString ParseXHtmlString(string xpath, string defaultValue = "")
        {
            var str =  ParseHTML(xpath);

            return new XhtmlString(str);
        }
