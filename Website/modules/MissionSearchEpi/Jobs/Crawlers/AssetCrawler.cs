...
namespace MissionSearchEpi.Crawlers
{
    public class AssetCrawler<T> where T : ISearchDocument
    {
        ...
        /// <param name="crawlStartDate"></param>
        /// <returns></returns>
        public List<ContentCrawlProxy> CrawlFolders(IEnumerable<ContentFolder> rootFolders, DateTime? crawlStartDate)
        {
            var assets = new List<ContentCrawlProxy>();
        ...
        /// <param name="crawlStartDate"></param>
        /// <returns></returns>
        private List<ContentCrawlProxy> GetAssets(ContentReference folder, DateTime? crawlStartDate)
        {
            var assets = new List<ContentCrawlProxy>();
