...
namespace MissionSearchEpi.UI.Blocks
{
    ...
    public class RangeFacetBlock : BlockData, IFacetBlock, ISearchBlock
    {
        ...
        [EditorDescriptor(EditorDescriptorType = typeof(SelectionEditorDescriptor<SearchDocTaggedSelectionFactory<SearchDocument, MissionSearch.Attributes.RangeFacetField>>))]
